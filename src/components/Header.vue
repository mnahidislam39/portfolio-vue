...
const headerData = portfolioData.header;
...
<template>
   ...
   >
      <div
         ...
         <a href="/" @click="handleNavClick('#home')" class="flex items-center gap-3 cursor-pointer group">
            <img 
         ...
         <nav :class="isDark ? 'text-slate-300' : 'text-slate-600'" class="items-center hidden gap-8 text-xs font-bold lg:flex transition-colors duration-300">
            <a 
         ...
         <div class="flex items-center gap-3">
            ...
            <a :href="headerData.ctaLink"
               ...
               class="hidden px-6 py-2.5 rounded-full font-bold text-xs transition-all shadow-md cursor-pointer sm:inline-block">
               {{ headerData.ctaText }}
            </a>
      ...
      <transition
         ...
         <div v-if="isOpen" 
            ...
            <a :href="headerData.ctaLink" @click="handleNavClick(headerData.ctaLink)"
               :class="isDark ? 'bg-white text-black hover:bg-[#009966] hover:text-white' : 'bg-slate-900 text-white hover:bg-[#009966] hover:text-white'"
